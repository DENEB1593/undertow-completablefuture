...
@Service
public class ApiFetcher2 {

  private final Logger LOG = LoggerFactory.getLogger(ApiFetcher2.class);

  private final Gson gson;

  public ApiFetcher2(Gson gson) {
    this.gson = gson;
  }


  public UserDto fetch(String id)  {
    LOG.info("===== ApiFetcher 2 started =====");
    try {
    ...
    if (response.getStatusCode() == HttpStatus.OK) {
      ...
      LOG.info("===== ApiFetcher 2 finished =====");
      return userDto;
    }
